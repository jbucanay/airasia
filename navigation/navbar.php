        ...
        if(isset($_SESSION['user'])){
            ...
            if($_SESSION['user']['role'] == 'Customer'){
                echo <<<_end
                            ...
                            <li class="nav-item">
                    <a id='redeem_link' class="nav-link" href="../redeem/redeem.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-heart-fill" viewBox="0 0 16 16">
